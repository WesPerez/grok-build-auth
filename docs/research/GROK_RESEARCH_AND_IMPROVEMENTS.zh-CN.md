...
> 历史说明：本文记录 2026-07-12 的旧基线，代理部分已被 2026-08 的统一控制面、
> 3 个共享 Sub2 profile 和账号级 Resin lease 方案取代。文中的静态 ProxyID、全局
> HTTP(S)_PROXY 和“导入时绑定注册节点”等描述仅作历史参考，不得用于恢复当前生产配置。
